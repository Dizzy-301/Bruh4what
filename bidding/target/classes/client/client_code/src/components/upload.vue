<template>
    <div>
        <el-upload v-if="type=='img'" class="img-uploader" :action="uploadUrl" list-type="picture-card" :limit="limit"
                   :multiple="multiple"
                   v-model:file-list="fileList" :on-success="uploadSuccess" :on-exceed="uploadExceed"
                   :disabled="disabled"
        ...
        <el-upload v-else class="upload-demo" drag :action="uploadUrl" :headers="uploadHeaders" :limit="limit"
                   ...
                   :on-success="uploadSuccess" :on-error="uploadError" :on-exceed="uploadExceed"
