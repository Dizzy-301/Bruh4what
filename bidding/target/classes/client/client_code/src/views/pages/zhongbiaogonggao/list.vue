    ...
    <div class="list-page" :style='{}'>
        ...
        <el-form :inline="true" :model="searchQuery" class="list_search">
            ...
            <div class="search_btn_view">
                ...
                <el-button class="add_btn" type="success" v-if="btnAuth('zhongbiaogonggao','新增')" @click="addClick">新增
                </el-button>
            </div>
        </el-form>
        <div class="page_list">
            <div class="data_box">
                <div class="table_view">
                    <el-table v-loading="listLoading" class="data_table" :data="list" border
                        ...
                        <el-table-column label="结果" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                <el-button v-if="scope.row.jieguo" type="text" size="small"
                                           @click.stop="download(scope.row.jieguo)">下载
                                </el-button>
...
<script setup>
    ...
    const addClick = () => {
        router.push('/index/zhongbiaogonggaoAdd')
    }
    //判断是否从个人中心跳转
