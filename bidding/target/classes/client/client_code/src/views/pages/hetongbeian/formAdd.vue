    ...
    <div class="edit_view" :style='{}'>
        ...
        <el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="招标人" prop="zhaobiaoren">
                        <el-input class="list_inp" v-model="form.zhaobiaoren" placeholder="招标人"
                                  type="text" :readonly="!isAdd||disabledForm.zhaobiaoren?true:false"/>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item label="投标人账号" prop="toubiaorenzhanghao">
                        <el-input class="list_inp" v-model="form.toubiaorenzhanghao" placeholder="投标人账号"
                                  type="text" :readonly="!isAdd||disabledForm.toubiaorenzhanghao?true:false"/>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item label="投标人姓名" prop="toubiaorenxingming">
                        <el-input class="list_inp" v-model="form.toubiaorenxingming" placeholder="投标人姓名"
                                  type="text" :readonly="!isAdd||disabledForm.toubiaorenxingming?true:false"/>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item label="签约时间" prop="qianyueshijian">
                        <el-date-picker
                                class="list_date"
                                v-model="form.qianyueshijian"
                                format="YYYY-MM-DD HH:mm:ss"
                                value-format="YYYY-MM-DD HH:mm:ss"
                                type="datetime"
                                style="width:100%;"
                                :readonly="!isAdd||disabledForm.qianyueshijian?true:false"
                                placeholder="请选择签约时间"/>
                    </el-form-item>
                </el-col>
            </el-row>
...
<script setup>
    ...
    const disabledForm = ref({
        ...
        qiyezhanghao: false,
        qiyemingcheng: false,
        toubiaorenzhanghao: false,
        toubiaorenxingming: false,
        hetong: false,
        qianyueshijian: false,
    })
    ...
    const init = (formId = null, formType = 'add', formNames = '', row = null, table = null, statusColumnName = null, tips = null, statusColumnValue = null) => {
        ...
        if (formType == 'add') {
            ...
            for (let x in row) {
                ...
                if (x == 'toubiaorenzhanghao') {
                    form.value.toubiaorenzhanghao = row[x];
                    disabledForm.value.toubiaorenzhanghao = true;
                    continue;
                }
                ...
                if (x == 'qianyueshijian') {
                    form.value.qianyueshijian = row[x];
                    disabledForm.value.qianyueshijian = true;
                    continue;
                }
            }
            if (row) {
        ...
        context?.$http({
            ...
            if (json.hasOwnProperty('toubiaorenzhanghao') && context?.$toolUtil.storageGet("frontRole") != "管理员") {
                form.value.toubiaorenzhanghao = json.toubiaorenzhanghao
                disabledForm.value.toubiaorenzhanghao = true;
            }
            if (json.hasOwnProperty('toubiaorenxingming') && context?.$toolUtil.storageGet("frontRole") != "管理员") {
