        ...
        <div class="detail_view">
            ...
            <div class="info_view">
                ...
                <div class="info_item">
                    ...
                    <div class="info_text">{{detail.shoujihao}}</div>
                </div>
                ...
                <div class="btn_view">
                    <el-button class="approval_btn" v-if="btnAuth('tousuxinxi','审核')" type="warning"
                               @click="approvalClick()">审核
                    </el-button>
                    <el-button class="edit_btn" v-if="centerType&&btnAuth('tousuxinxi','修改')" type="primary"
                               @click="editClick">修改
                    </el-button>
                    <el-button class="del_btn" v-if="centerType&&btnAuth('tousuxinxi','删除')" type="danger"
                               @click="delClick">删除
                    </el-button>
                </div>
            </div>
