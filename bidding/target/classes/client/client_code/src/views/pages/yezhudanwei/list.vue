    ...
    <div class="list-page" :style='{}'>
        ...
        <el-form :inline="true" :model="searchQuery" class="list_search">
            ...
            <div class="search_btn_view">
                ...
                <el-button class="add_btn" type="success" v-if="btnAuth('yezhudanwei','新增')" @click="addClick">新增
                </el-button>
            </div>
        </el-form>
        <div class="page_list">
            <div class="data_box">
                <div class="table_view">
                    <el-table v-loading="listLoading" class="data_table" :data="list" border
                        ...
                        <el-table-column label="资质" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                <div v-if="scope.row.zizhi">
                                    <el-image v-if="scope.row.zizhi.substring(0,4)=='http'" preview-teleported
                                              ...
                                              :src="scope.row.zizhi.split(',')[0]" style="width:100px;height:100px"
                                              @click.stop></el-image>
                                    <el-image v-else preview-teleported
                                              :preview-src-list="[$config.url+scope.row.zizhi.split(',')[0]]"
                                              :src="$config.url+scope.row.zizhi.split(',')[0]"
...
<script setup>
    ...
    const addClick = () => {
        router.push('/index/yezhudanweiAdd')
    }
    //判断是否从个人中心跳转
