    ...
    <div class="list-page" :style='{}'>
        ...
        <el-form :inline="true" :model="searchQuery" class="list_search">
            ...
            <div class="search_btn_view">
                ...
                <el-button class="add_btn" type="success" v-if="btnAuth('zhaobiaoxiangmu','新增')" @click="addClick">新增
                </el-button>
            </div>
        </el-form>
        <div class="page_list">
            <div class="data_box">
                <div class="data_view">
                    <div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)">
                        <div class="data_img_box" v-if="item.fengmian && item.fengmian.substr(0,4)=='http'"
                             @click.stop="preViewClick(item.fengmian)">
                            <el-image class="data_img" :src="item.fengmian" fit="cover"></el-image>
                        </div>
                        <div class="data_img_box" v-else
                             @click.stop="preViewClick($config.url+item.fengmian.split(',')[0])">
                            <el-image class="data_img" :src="item.fengmian?$config.url + item.fengmian.split(',')[0]:''"
                                      fit="cover"></el-image>
                        </div>
                        <div class="data_content">
                            <div class="data_title1">
                                <span>项目名称：{{item.xiangmumingcheng}}</span>
                            </div>
                            <div class="data_title2">
                                <span>企业账号：{{item.qiyezhanghao}}</span>
                            </div>
                            <div class="data_title3">
                                <span>企业名称：{{item.qiyemingcheng}}</span>
                            </div>
                            <div class="data_title4" v-if="item.xiangmuyusuan">
                                <span>项目预算：{{item.xiangmuyusuan}}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script setup>
    ...
    const addClick = () => {
        router.push('/index/zhaobiaoxiangmuAdd')
    }
    //判断是否从个人中心跳转
