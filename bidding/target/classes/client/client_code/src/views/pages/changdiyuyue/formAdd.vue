                ...
                <el-col :span="12">
                    <el-form-item label="场地名称" prop="changdimingcheng">
                        <el-input class="list_inp" v-model="form.changdimingcheng" placeholder="场地名称"
                                  type="text" :readonly="!isAdd||disabledForm.changdimingcheng?true:false"/>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item label="场地类型" prop="changdileixing">
                        <el-input class="list_inp" v-model="form.changdileixing" placeholder="场地类型"
                                  type="text" :readonly="!isAdd||disabledForm.changdileixing?true:false"/>
                    </el-form-item>
                </el-col>
...
<script setup>
    ...
    const init = (formId = null, formType = 'add', formNames = '', row = null, table = null, statusColumnName = null, tips = null, statusColumnValue = null) => {
        ...
        context?.$http({
            ...
            if (json.hasOwnProperty('shhf') && context?.$toolUtil.storageGet("frontRole") != "管理员") {
