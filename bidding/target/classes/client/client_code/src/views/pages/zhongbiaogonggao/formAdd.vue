            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="结果" prop="jieguo">
                        <uploads
                                :disabled="!isAdd||disabledForm.jieguo?true:false"
                                type="file"
                                action="file/upload"
                                tip="请上传结果"
                                :limit="1"
                                style="width: 100%;text-align: left;"
                                :fileUrls="form.jieguo?form.jieguo:''"
                                @change="jieguoUploadSuccess">
                        </uploads>
                    </el-form-item>
                </el-col>
            </el-row>
...
<script setup>
    ...
    //提交
    const save = () => {
        if (form.value.jieguo != null) {
            form.value.jieguo = form.value.jieguo.replace(new RegExp(context?.$config.url, "g"), "");
        }
