    ...
    <div>
        <div class="register_view">
            <el-form :model="registerForm" class="register_form">
                ...
                <div class="list_item">
                    <div class="list_label">投标账号：</div>
                    <input class="list_inp"
                           v-model="registerForm.toubiaozhanghao"
                           placeholder="请输入投标账号"
                           type="text"
                    />
                </div>
                ...
                <div class="list_item">
                    <div class="list_label">投标人姓名：</div>
                    <input class="list_inp"
                           v-model="registerForm.toubiaorenxingming"
                           placeholder="请输入投标人姓名"
                           type="text"
                    />
                </div>
                <div class="list_item">
                    ...
                    <el-select
                            ...
                            placeholder="请选择性别"
                    >
                        <el-option v-for="item in toubiaodanweixingbieLists" :label="item" :value="item"></el-option>
                    </el-select>
                </div>
                <div class="list_item">
...
<script setup>
    ...
    const handleRegister = () => {
        ...
        if (registerForm.value.shoujihao && (!context?.$toolUtil.isMobile(registerForm.value.shoujihao))) {
