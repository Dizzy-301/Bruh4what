                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="投标账号" prop="toubiaozhanghao">
                            <el-input class="list_inp" v-model="user.toubiaozhanghao" readonly placeholder="投标账号"
                                      clearable/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="投标人姓名" prop="toubiaorenxingming">
                            <el-input class="list_inp" v-model="user.toubiaorenxingming" placeholder="投标人姓名" clearable/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="性别" prop="xingbie">
                            <el-select
                                    ...
                                    placeholder="请选择性别"
                            >
                                <el-option v-for="item in toubiaodanweixingbieLists" :label="item"
                    ...
                    <el-col :span="24">
                        <el-form-item label="手机号" prop="shoujihao">
                            <el-input class="list_inp" v-model="user.shoujihao" placeholder="手机号" clearable/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="头像" prop="touxiang">
                            <uploads
                                    ...
                                    @change="toubiaodanweitouxiangUploadSuccess">
                            </uploads>
                        </el-form-item>
                    </el-col>
...
<script setup>
    ...
    const tableName = ref('toubiaodanwei')
    const user = ref({})
    const toubiaodanweixingbieLists = ref([])
    const init = () => {
        toubiaodanweixingbieLists.value = "男,女".split(',')
    }
    const toubiaodanweitouxiangUploadSuccess = (fileUrls) => {
    ...
    const onSubmit = () => {
        ...
        if ((user.value.shoujihao) && (!context?.$toolUtil.isMobile(user.value.shoujihao))) {
            context?.$toolUtil.message(`手机号应输入手机格式`, 'error')
            return false
        }
