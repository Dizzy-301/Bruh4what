    ...
    <div>
        <div class="register_view">
            <el-form :model="registerForm" class="register_form">
                ...
                <div class="list_item">
                    <div class="list_label">代理公司账号：</div>
                    <el-input class="list_inp"
                              v-model="registerForm.dailigongsizhanghao"
                              placeholder="请输入代理公司账号"
                              type="text"
                    />
                </div>
                <div class="list_item">
                ...
                <div class="list_item">
                    <div class="list_label">代理公司名称：</div>
                    <el-input class="list_inp"
                              v-model="registerForm.dailigongsimingcheng"
...
<script setup>
    ...
    const handleRegister = () => {
        ...
        if ((!registerForm.value.dailigongsizhanghao)) {
        ...
        if ((!registerForm.value.dailigongsimingcheng)) {
