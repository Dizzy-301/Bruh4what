    ...
    <div>
        <div class="center_view">
            <div class="list_search_view">
                <el-form :model="searchQuery" class="search_form">
                    <div class="search_view">
                        ...
                        <div class="search_box">
                            <el-input class="search_inp" v-model="searchQuery.changdimingcheng" placeholder="场地名称"
                                      clearable>
                            </el-input>
                        </div>
                    </div>
                ...
                <div class="btn_view">
                    <el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('changdiyuyue','新增')">
                        新增
                    </el-button>
                    <el-button class="del_btn" type="danger" :disabled="selRows.length?false:true"
                               @click="delClick(null)" v-if="btnAuth('changdiyuyue','删除')">
                        删除
                    </el-button>
                </div>
            </div>
            <el-table
                ...
                <el-table-column label="审核" v-if="btnAuth('changdiyuyue','审核')" :resizable='true' :sortable='true'
                                 align="left" header-align="left">
                    <template #default="scope">
...
<script setup>
    ...
    const getList = () => {
        ...
        params['sort'] = 'id'
        params['order'] = 'desc'
        if (searchQuery.value.changdimingcheng && searchQuery.value.changdimingcheng != '') {
            params['changdimingcheng'] = '%' + searchQuery.value.changdimingcheng + '%'
        }
    ...
    const approvalClick = (row) => {
        let params = {
            ...
            toubiaozhanghao: row.toubiaozhanghao,
            toubiaorenxingming: row.toubiaorenxingming,
            sfsh: row.sfsh,
            shhf: row.shhf,
        }
        nextTick(() => {
