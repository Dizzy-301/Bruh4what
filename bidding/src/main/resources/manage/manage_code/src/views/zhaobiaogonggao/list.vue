    ...
    <div>
        <div class="center_view">
            <div class="list_search_view">
                ...
                <div class="btn_view">
                    <el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('zhaobiaogonggao','新增')">
                        新增
                    </el-button>
                    <el-button class="del_btn" type="danger" :disabled="selRows.length?false:true"
                               @click="delClick(null)" v-if="btnAuth('zhaobiaogonggao','删除')">
                        删除
                    </el-button>
                </div>
            </div>
            <el-table
                    ...
                    ref="table"
                    v-if="btnAuth('zhaobiaogonggao','查看')"
                    :data="list"
                ...
                <el-table-column label="招标公告文件" min-width="140" :resizable='true' :sortable='true' align="left"
                                 header-align="left">
                    <template #default="scope">
                        <el-button v-if="scope.row.zhaobiaogonggaowenjian" link size="small"
                                   @click="download(scope.row.zhaobiaogonggaowenjian)">下载
                        </el-button>
                ...
                <el-table-column label="合同条款" min-width="140" :resizable='true' :sortable='true' align="left"
                                 header-align="left">
                    <template #default="scope">
                        <el-button v-if="scope.row.hetongtiaokuan" link size="small"
                                   @click="download(scope.row.hetongtiaokuan)">下载
                        </el-button>
                        <el-button v-else disabled link size="small">无</el-button>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="审核回复" min-width="140" :resizable='true' :sortable='true' align="left"
                                 header-align="left">
                    <template #default="scope">
                        {{scope.row.shhf}}
                    </template>
                </el-table-column>
                <el-table-column prop="sfsh" label="审核状态" min-width="140" :resizable='true' :sortable='true'
                ...
                <el-table-column label="审核" v-if="btnAuth('zhaobiaogonggao','审核')" :resizable='true' :sortable='true'
                                 align="left" header-align="left">
                    <template #default="scope">
...
<script setup>
    ...
    const approvalClick = (row) => {
        let params = {
            ...
            zhaobiaogonggaowenjian: row.zhaobiaogonggaowenjian,
