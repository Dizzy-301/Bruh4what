    ...
    <div>
        <div class="login_view">
            <el-form :model="loginForm" class="login_form">
                <div class="title_view">基于springboot的在线招标投标系统的设计与实现登录</div>
                ...
                <div class="btn_view">
                    ...
                    <el-button class="register" type="primary" @click="handleRegister('yezhudanwei')">注册业主单位</el-button>
                    <el-button class="register" type="primary" @click="handleRegister('zhaobiaodaili')">注册招标代理
                    </el-button>
...
<style lang="scss" scoped>
    .login_view {
        background-image: url("http://clfile.zggen.cn/20240916/eb2285ada5a94b00bd896b29433fd009.webp");
        // 表单盒子
        .login_form {
        }
