    ...
    <div class="list-page" :style='{}'>
        ...
        <el-form :inline="true" :model="searchQuery" class="list_search">
            ...
            <div class="search_btn_view">
                ...
                <el-button class="add_btn" type="success" v-if="btnAuth('zhaobiaogonggao','新增')" @click="addClick">新增
                </el-button>
            </div>
        </el-form>
        <div class="page_list">
            <div class="data_box">
                <div class="table_view">
                    <el-table v-loading="listLoading" class="data_table" :data="list" border
                        ...
                        <el-table-column label="招标范围" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                {{scope.row.zhaobiaofanwei}}
                            </template>
                        </el-table-column>
                        <el-table-column label="招标公告文件" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                <el-button v-if="scope.row.zhaobiaogonggaowenjian" type="text" size="small"
                                           @click.stop="download(scope.row.zhaobiaogonggaowenjian)">下载
                                </el-button>
                                <el-button v-else disabled type="text" size="small">无</el-button>
                            </template>
                        </el-table-column>
                        <el-table-column label="投标截止时间" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                {{scope.row.toubiaojiezhishijian}}
                            </template>
                        </el-table-column>
                        <el-table-column label="开标时间" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                {{scope.row.kaibiaoshijian}}
                            </template>
                        </el-table-column>
                        <el-table-column label="项目地点" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                {{scope.row.xiangmudidian}}
                            </template>
                        </el-table-column>
                        <el-table-column label="项目周期" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                {{scope.row.xiangmuzhouqi}}
                            </template>
                        </el-table-column>
                        <el-table-column label="合同条款" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                <el-button v-if="scope.row.hetongtiaokuan" type="text" size="small"
                                           @click.stop="download(scope.row.hetongtiaokuan)">下载
                                </el-button>
                                <el-button v-else disabled type="text" size="small">无</el-button>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="审核回复" v-if="centerType" :resizable='true' align="left"
                                         header-align="left">
                            <template #default="scope">
                                {{scope.row.shhf}}
                            </template>
                        </el-table-column>
                        <el-table-column label="审核状态" v-if="centerType" :resizable='true' align="left"
                                         header-align="left">
                            <template #default="scope">
...
<script setup>
    ...
    const addClick = () => {
        router.push('/index/zhaobiaogonggaoAdd')
    }
    //判断是否从个人中心跳转
