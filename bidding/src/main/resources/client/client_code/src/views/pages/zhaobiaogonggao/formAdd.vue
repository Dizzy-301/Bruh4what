...
<script setup>
    ...
    const init = (formId = null, formType = 'add', formNames = '', row = null, table = null, statusColumnName = null, tips = null, statusColumnValue = null) => {
        ...
        context?.$http({
            ...
            if (json.hasOwnProperty('dailigongsizhanghao') && context?.$toolUtil.storageGet("frontRole") != "管理员") {
                form.value.dailigongsizhanghao = json.dailigongsizhanghao
                disabledForm.value.dailigongsizhanghao = true;
            }
            if (json.hasOwnProperty('dailigongsimingcheng') && context?.$toolUtil.storageGet("frontRole") != "管理员") {
