            ...
            <div class="info_view">
                <div class="title_view">
                    <div class="detail_title">
                        <span>{{detail.changdimingcheng}}</span>
                    </div>
                </div>
                <div class="info_item">
                    <div class="info_label">场地类型</div>
                    <div class="info_text">{{detail.changdileixing}}</div>
                </div>
                <div class="info_item">
                ...
                <div class="info_item">
                    ...
                    <div class="info_text">{{detail.shiyongshijian}}</div>
                </div>
                <div class="info_item">
                ...
                <div class="btn_view">
                    <el-button class="approval_btn" v-if="btnAuth('changdiyuyue','审核')" type="warning"
                               @click="approvalClick()">审核
                    </el-button>
                    <el-button class="edit_btn" v-if="centerType&&btnAuth('changdiyuyue','修改')" type="primary"
                               @click="editClick">修改
                    </el-button>
                    <el-button class="del_btn" v-if="centerType&&btnAuth('changdiyuyue','删除')" type="danger"
                               @click="delClick">删除
                    </el-button>
                </div>
            </div>
...
<script setup>
    ...
    const getDetail = () => {
        context?.$http({
            ...
            title.value = res.data.data.changdimingcheng
    ...
    const approvalClick = (btnType = '审核') => {
        ...
        if (!btnAuth('changdiyuyue', btnType)) {
