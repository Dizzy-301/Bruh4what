        ...
        <div class="usersView">
            ...
            <div class="usersBox updateInfo" v-if="tabIndex=='center'">
                <el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
                    <el-row>
                        <el-col :span="12">
                            <el-form-item prop="toubiaozhanghao" label="投标账号">
                                <el-input class="list_inp" v-model="userForm.toubiaozhanghao" placeholder="投标账号"
                                          readonly></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item prop="toubiaorenxingming" label="投标人姓名">
                                <el-input class="list_inp" v-model="userForm.toubiaorenxingming"
                                          placeholder="投标人姓名"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item prop="shenfenzhenghao" label="身份证号">
                                <el-input class="list_inp" v-model="userForm.shenfenzhenghao"
                                          placeholder="身份证号"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item prop="shoujihao" label="手机号">
                                <el-input class="list_inp" v-model="userForm.shoujihao" placeholder="手机号"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="24">
