    ...
    <div class="list-page" :style='{}'>
        ...
        <el-form :inline="true" :model="searchQuery" class="list_search">
            ...
            <div class="search_btn_view">
                ...
                <el-button class="add_btn" type="success" v-if="btnAuth('zhaobiaojihua','新增')" @click="addClick">新增
                </el-button>
            </div>
        </el-form>
        <div class="page_list">
            <div class="data_box">
                <div class="table_view">
                    <el-table v-loading="listLoading" class="data_table" :data="list" border
                        ...
                        <el-table-column label="计划文件" :resizable='true' align="left" header-align="left">
                            <template #default="scope">
                                <el-button v-if="scope.row.jihuawenjian" type="text" size="small"
                                           @click.stop="download(scope.row.jihuawenjian)">下载
                                </el-button>
...
<script setup>
    ...
    const addClick = () => {
        router.push('/index/zhaobiaojihuaAdd')
    }
    //判断是否从个人中心跳转
