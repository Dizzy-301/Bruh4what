...
public class ToubiaoxinxiEntity<T> implements Serializable {
     ...
     * 投标总报价
     */
    private Double toubiaozongbaojia;
    ...
    public void setToubiaozongbaojia(Double toubiaozongbaojia) {
        this.toubiaozongbaojia = toubiaozongbaojia;
    }

    public Double getToubiaozongbaojia() {
        return toubiaozongbaojia;
    }
